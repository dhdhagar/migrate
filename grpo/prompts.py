...
def get_arc_datasets(task_id, arc_dataset_file, arc_dataset_solution_file, minimum_training_size=50, do_permutation=False):
    """
    ...
    dataset = training_dataset * ((minimum_training_size // len(training_dataset)) + 1)
